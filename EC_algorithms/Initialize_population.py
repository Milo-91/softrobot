...
def with_local_search(robot_m, options, prefix, evaluator, eval_count, lock, local_search):
  population = []
  ...
  for _ in range(int(1/elites_percentage)):
  ...
  return population, best_robot, meantime
