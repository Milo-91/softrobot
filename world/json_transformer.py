...
def main():
    grid = add_from_json('/Users/linchecheng/Desktop/上課用/大五下/TsukubaResearch/YASRE/world/evogym_world/sim_files/Hurdler-v0.json')
    save_json('world.walk_line', 'Hurdler-v0T.json', grid)
